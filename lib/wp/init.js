...
/**
 * Handles installing WordPress.
 *
 * @param   {Function}  callback  The function to be executed on completion.
 *
 * @return  {Boolean}              `false`
 */
wp.installWP = function( callback ) {
	var fs = require( 'fs' );

	// CD to root "server directory"
	sn.chdir( sn.options.config.install.directory, function() {
		wp.makeInstallDirectory(function(){
			wp.installCore(function(){
